...
In this project, we will be practicing object relationships in Ruby, with a particular emphasis on the has-many-through relationship. 
 ...
 We will be building out a domain model in which a User has a collection of RecipeCards. 
 ...
 A Recipe also has many Ingredients, while 
 a single Ingredient can be found in many Recipes. 
